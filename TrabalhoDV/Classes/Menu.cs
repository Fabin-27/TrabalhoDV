...
namespace TrabalhoDV.Classes
{
    class Menu
    {
                                    ...
                                    case 1:
                                        ...
                                        switch (x)
                                        {
                                            ...
                                            case 1:
                                                ...
                                                {
                                                    Console.Clear();
                                                    Console.WriteLine("Este banco não possui Correntistas ainda");
                                                    Console.WriteLine();
                                                    Inicializar();
                                                }
                                            ...
                                            case 3:
                                                ...
                                                {
                                                    Console.Clear();
                                                    Console.WriteLine("Este banco não possui Correntista ainda");
                                                    Console.WriteLine();
                                                    Inicializar();
                                                }
        ...
        private void CadastrarCorrentista()
        {
            ...
            ct.numero_C = int.Parse(Console.ReadLine());

            new CorrentistaFactory(this.banco).Salvar(correntista);
        ...
        private void InformacoesBancarias()
        {
            ...
            Console.WriteLine("Nome: " + ct.Codigo);
            Console.WriteLine("Nome: " + ct.Nome);
            Console.WriteLine("CPF: " + ct.CPF);
            Console.WriteLine("Agencia: " + ct.agencia);
            Console.WriteLine("Numero da Conta: " + ct.numero_C);
